...
class DeviceManagerClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            devicePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/registries/{registry}/devices/{device}'),
            locationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}'),
            registryPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/registries/{registry}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listDeviceRegistries: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deviceRegistries'),
            listDevices: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'devices'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.iot.v1.DeviceManager', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.deviceManagerStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.iot.v1.DeviceManager')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.iot.v1.DeviceManager, this._opts);
        ...
        for (const methodName of deviceManagerStubMethods) {
            const callPromise = this.deviceManagerStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listDeviceRegistriesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listDeviceRegistries.createStream(this.innerApiCalls.listDeviceRegistries, request, callSettings);
    }
    /**
    ...
    listDeviceRegistriesAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listDeviceRegistries.asyncIterate(this.innerApiCalls['listDeviceRegistries'], request, callSettings);
    }
    /**
    ...
    listDevicesStream(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listDevices.createStream(this.innerApiCalls.listDevices, request, callSettings);
    }
    /**
    ...
    listDevicesAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listDevices.asyncIterate(this.innerApiCalls['listDevices'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
